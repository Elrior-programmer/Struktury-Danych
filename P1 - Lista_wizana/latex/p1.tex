...
\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_Array_add_at_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_Array_at_back_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_Array_at_front_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_Array_find_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_Array_remove_at_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_Array_remove_back_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_Array_remove_front_longlongv2_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_List_add_at_longlongv2_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_List_add_back_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_List_add_front_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_List_find_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_List_remove_at_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_List_remove_back_longlong_srednia.png}
\end{center}

\begin{center}
    \includegraphics[width=\linewidth]{wykresy/S2_List_remove_front_longlong_srednia.png}
\end{center}
